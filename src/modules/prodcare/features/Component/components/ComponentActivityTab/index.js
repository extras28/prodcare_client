...
ComponentActivityTab.propTypes = {};

function ComponentActivityTab(props) {
  // MARK: --- Params ---
  ...
  useEffect(() => {
    if (!!componentDetail?.id) {
      setFilters({ ...filters, componentId: componentDetail?.id });
      Global.gFiltersEventList = { ...filters, componentId: componentDetail?.id };
    }
  }, [componentDetail]);
