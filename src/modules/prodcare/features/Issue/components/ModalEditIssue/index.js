            ...
            <div className="row">
              ...
              <div className="col-12">
                <KTFormGroup
                  label={
                    <>
                      {t('ErrorStatus')} <span className="text-danger">*</span>
                    </>
                  }
                  inputName="status"
                  inputElement={
              ...
              {/* DescriptionOfThePhenomenon */}
              <div className="col-12">
                <KTFormGroup
                  label={
                    <>
                      {t('DescriptionOfThePhenomenon')} <span className="text-danger">*</span>
                    </>
                  }
                    ...
                    <FastField name="description">
                      {({ field, form, meta }) => (
                        <KTFormTextArea
                          ...
                          placeholder={`${_.capitalize(t('DescriptionOfThePhenomenon'))}...`}
                            ...
                            setChangeObj((prev) => {
                              return {
                                ...
                                [`${t('ImpactPoint')}`]: `${t(
                                  ...
                                  AppData.impactPoints.find((item) => item.value === newValue)?.name
                                )}`,
                              };
                            });
                          }}
                            ...
                            setChangeObj((prev) => {
                              return {
                                ...
                                [`${t('OverdueKpiReason')}`]: `${t(
                                  ...
                                  AppData.overdueKpiReasons.find((item) => item.value === newValue)
                                    ?.name
                                )}`,
                              };
                            });
                    ...
                    <FastField name="reason">
                      {({ field, form, meta }) => (
                        <KTFormTextArea
                          ...
                          isTouched={meta.touched}
                          feedbackText={meta.error}
                          placeholder={`${_.capitalize(t('ReasonCausingError'))}...`}
                          type={KTFormInputType.text}
                          disabled={current?.role === 'GUEST'}
                        />
                      )}
                        ...
                        <KTFormInput
                          ...
                          onChange={(value) => {
                            ...
                            setChangeObj((prev) => {
                              return {
                                ...prev,
                                [`${t('UnitPrice')}`]: `${issueItem?.unit_price ?? ''} -> ${value}`,
                              };
                            });
                          }}
                          onBlur={() => form.setFieldTouched(field.name, true)}
                          ...
                          onValueChanged={(newValue) => {
                            ...
                            setChangeObj((prev) => {
                              ...
                              return {
                                ...prev,
                                [`${t('WarrantyStatus')}`]: `${t(
                                  data.find((item) => item.value === issueItem?.['warranty_status'])
                                    .name
